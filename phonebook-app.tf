...
locals {
  github-repo = "https://github.com/cemalsenel/phonebook-app.git"
  github-file-url = "https://raw.githubusercontent.com/cemalsenel/phonebook-app/master/"
}
...
resource "aws_ecr_repository" "ecr-repo" {
  name                 = "jimmy-image-repo/phonebook-app"
...
resource "aws_instance" "docker-machine-managers" {
  ...
  tags = {
    Name = "jimmy-Docker-Swarm-Manager-${count.index + 1}"
  }
...
resource "aws_instance" "docker-machine-workers" {
  ...
  tags = {
    Name = "jimmy-Docker-Swarm-Worker-${count.index + 1}"
  }
  depends_on = [aws_instance.docker-machine-leader-manager]
}
...
resource "aws_security_group" "tf-docker-sec-gr" {
  name = "jimmy-docker-swarm-sec-gr"
  tags = {
    Name = "swarm-sec-gr"
  }
  dynamic "ingress" {
